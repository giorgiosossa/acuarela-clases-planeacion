...
export default function Create({ programs: initialPrograms, canCreateProgram = true }: Props) {
    ...
    const handleCreateProgram = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok && result.success) {
                ...
                // Seleccionar automáticamente el nuevo programa
        ...
        <AppLayout>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-3xl sm:px-6 lg:px-8">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle className="text-2xl">Crear Nivel</CardTitle>
                            <CardDescription>
                                Agrega un nuevo nivel al programa de natación
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
