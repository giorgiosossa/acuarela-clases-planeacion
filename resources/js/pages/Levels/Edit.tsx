...
import { ArrowLeft, Plus, CheckCircle2, List, Pencil, Trash2 } from 'lucide-react';
...
export default function Edit({ level, programs: initialPrograms, canCreateProgram = true }: Props) {
